...
#         ver = hor
#     return ver
def stackImages(scale, imgs, cols):
    rows = math.ceil(len(imgs) / cols)

    imgArray = []
    for i in range(0, len(imgs), cols):
        imgArray.append(imgs[i:i+cols] )
...
imgStack = stackImages(0.6, [img, imgGray, img, img, img, img], 4)


# cv2.imshow('Lenna horizontal', imgHor)
# cv2.imshow('Lenna vertical', imgVer)
